...
**Institution / Target**: Wycherley International School, Gampaha  
...
flowchart TD
    ...
    Cloudflare["Cloudflare Zero-Trust HTTPS Tunnel"]
    Nginx["Nginx Reverse Proxy (:80 / :443)"]
    SpringBoot["Spring Boot 3.2.3 Backend (:8080)"]
    MySQL[("MySQL 8.4 Production Database")]

    Client -->|HTTPS| Cloudflare
    Cloudflare -->|Encrypted Loopback| Nginx
    Nginx -->|SPA Static Assets| Client
    Nginx -->|/api/v1 Reverse Proxy| SpringBoot
    SpringBoot -->|HikariCP Connection Pool| MySQL
```
